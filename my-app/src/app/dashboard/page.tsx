      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {user && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {/* Stat 1 */}
                <div className="bg-white p-6 rounded-2xl border-b border-neutral-300 ring ring-neutral-200/80 shadow flex items-center gap-4">
        ...
        {/* --- HERO SECTION --- */}
        <div className="bg-gradient-to-br from-indigo-600 via-blue-700/80 to-indigo-400 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
            {/* Background Decor */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Link 1: Categories */}
            <Link href="/categories" className="group bg-white p-8 rounded-2xl border-b border-neutral-300 ring ring-neutral-200/80 shadow hover:ring-blue-500 hover:border-blue-500 hover:shadow-md transition-all">
            ...
            {user ? (
                <Link href="/history" className="group bg-white p-8 rounded-2xl border-b border-neutral-300 ring ring-neutral-200/80 shadow hover:ring-blue-500 hover:border-blue-500 hover:shadow-md transition-all">
                    <div className="mb-4 bg-slate-50 w-12 h-12 rounded-xl flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors">
            ...
            <Link href="/dashboard/B" className="group bg-white p-8 rounded-2xl border-b border-neutral-300 ring ring-neutral-200/80 shadow hover:ring-blue-500 hover:border-blue-500 hover:shadow-md transition-all">
                <div className="mb-4 bg-slate-50 w-12 h-12 rounded-xl flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-colors">
